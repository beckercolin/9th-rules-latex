...
\showunit{
	...
	options={
		\magicalitemsallowance{}=\upto{}<100,
		\magiclevel{4}=30,
		\maypurchasetwodarkshards{}=20,
		\maytakeoneofthefollowing{\onechoiceonly
			\becomeplaguepatriarch{}=20,
			\rideadoombell{}=200,
			},
	},
}
...
\showunit {
	...
	unitrules{
		...
		\unitrule{\professionalcourtesy}{\profesionalcourtesyrule}
	},
...
\showunit {
	...
	options={
		...
		\ifwizardmaypurchasetwodarkshards{}=20,
		\weapononechoice{
			\pw{}=3,
			\flail{}=4,
			\halberd{}=4,
...
\showunit{
	name={\jezails}, %rajouter (0-2 choix)
	cost=60,
	profile={ < 5 3 3 3 3 2 4 2 5},
	type=\infantry ,
	basesize=25x50,
...
\showunit{
	...
	unitsize=1,
	commontype=\vermincommonrules ,
	commonspecialrules={\safetyinnumbers, \volatile},
...
\showunit{
	...
	specialrules={\largetarget, \magicresistance{2}, \stubborn, \terror, \wardsave{4}, \warplatform, \soundingthebell, \abovethemasses},
	armour={\innatedefence{5}},
	unitrules={
