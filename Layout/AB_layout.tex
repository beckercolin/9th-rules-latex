...
\newcommand{\alignment}[1]{\unitentry{#1}{\textit{\labels@alignment\spacebeforecolon{}:}\newline\textbf{#1}.}}
...
\newcommand{\defunit}{
	\setkeys{unit}{%
		name=, profile=, cost=, invocation=, costpermodel=, maxmodels=, type=, unitsize=, basesize=, commonspecialrules=, commontype=, specialrules=, magiclevel=, magicpaths=, alignment=, equipment=, weapons=, armour=, wizardconclave=, unitequipment=, options=, mounts=, commandgroup=, unitrules=, additional=%
	}%
	\setkeys{unit}%
}
