...
\newcommand{\addtosortedlist}[1]{%
	\def\textwithoutspace{\expandafter\removespaces\expandafter{#1}}%
	\pdfstringdef\plaintexttemp{\textwithoutspace}%
...
\newcommand{\pts}[1]{#1~% First step is to remove spaces if there are some
	...
	\expandafter\ifstrequal\expandafter{\cleannumber}{1}{\labels@point}{\labels@points}%
}
