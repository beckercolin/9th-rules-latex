...
\usepackage{fontspec}
\setmainfont[Ligatures=TeX]{Cochin} % default is Latin Modern
...
\newcommand{\startarmyspecialrules}{\newpage\bigtitle{\labels@armyspecialrules}\largefontsize}
\newcommand{\closearmyspecialrules}{\normalfontsize}
\newcommand{\armyspecialruleentry}[1]{\subtitle{#1}\vspace{5pt}}

\newcommand{\startarmyarmoury}{\vspace*{1.5cm}\bigtitle{\labels@armoury}\largefontsize\subtitle{}}
...
\newcommand{\profilestart}{%
	...
	&%
	{\smallfontsize\labels@trooptype} &%
	{\smallfontsize\labels@basesize}%
}
...
\newcommand{\showunit}[1]{
	...
	\expandafter\ifstrequal\expandafter{\unit@unitsize}{1}{% single model
		...
		\expandafter\ifblank\expandafter{\unit@maxmodels}{% no		
			...
			{\hspace*{0.25cm}\large \textbf{1} \wordto{} \textbf{\unit@maxmodels} \labels@models{}\hfill {\smallfontsize\pricepermodelabovemin{}} {\largefontsize\pts{\textbf{\unit@costpermodel{}}}\permodel}\hspace*{0.1cm}}%
		}%
	}{% not single model					
			{\hspace*{0.25cm}\large \textbf{\unit@unitsize} \wordto{} \textbf{\unit@maxmodels} \labels@models{}\hfill {\smallfontsize\pricepermodelabovemin{}} {\largefontsize\pts{\textbf{\unit@costpermodel{}}}\permodel}\hspace*{0.1cm}}%
	}%
	}%
	\vspace*{-0.1cm}
