...
\newfontfamily\titlefont[Ligatures=TeX]{Georgia} % fancy font
...
%% Page utilities
\usepackage{parskip}			% No indentation and spacing between paragraphs
...
\newcommand{\profiledtbfillhypertag}[1]{\DTLnewdbentry{profiles}{hypertag}{#1}}
...
\newcommand{\profiledtbfillalliancepic}[1]{\DTLnewdbentry{profiles}{alliancepic}{#1}}
...
\titleformat{\subsection}{\hugefontsize\bfseries}{}{0pt}{}
...
\newcommand{\startarmywiderules}{\newpage\toctarget{widerulestitle}{\bigtitle{\labels@armywiderules}}\largefontsize}
\newcommand{\closearmywiderules}{\normalfontsize}
\newcommand{\armywideruleentry}[1]{\subtitle{#1}\vspace{5pt}}

\newcommand{\startarmyspecialrules}{\toctarget{specialrulestitle}{\bigtitle{\labels@armyspecialrules}}\largefontsize}
\newcommand{\closearmyspecialrules}{\normalfontsize}
\newcommand{\armyspecialruleentry}[1]{\subtitle{#1}\vspace{5pt}}

\newcommand{\startarmyarmoury}{\toctarget{armourytitle}{\bigtitle{\labels@armoury}}\largefontsize\subtitle{}}
\newcommand{\closearmyarmoury}{\normalfontsize}

\newcommand{\startarmymagicalitems}{\newpage\largefontsize\toctarget{magicalitemstitle}{\bigtitle{\labels@magicalitems}}\begin{multicols}{2}\raggedcolumns}
...
\newcommand{\quickrefsheettitle}{\clearpage\newgeometry{top=1.6cm, bottom=2cm, left=1cm, right=1cm}\toctarget{QRStitle}{\bigtitle{\labels@quickrefsheet}}\vspace*{0.4cm}}
\newcommand{\changelogtitle}{\clearpage\toctarget{changelogtitle}{\bigtitle{\labels@changelog}}\spaceaftersection{}}
...
% Magic entry.
\newcommand{\magic}[2]{\unitentry{#2}{\unitentryformat{\labels@magic\spacebeforecolon{}: }\newline\ifdefempty{#1}{}{\textbf{\magiclevel{#1}}. }\ifsubstring{#2}{NOPATH}{}{\labels@pathsused\expandafter\pathslist\expandafter{#2}.}}}
...
\newcommand{\alliance}[1]{\unitentry{#1}{\unitentryformat{\labels@alliance\spacebeforecolon{}:}\newline\textbf{#1}.}}

% Alliance options specific commands.
\define@key{allianceoptions}{change}            {\def\allianceoptions@change{#1}}
\define@key{allianceoptions}{lust}               {\def\allianceoptions@lust{#1}}
\define@key{allianceoptions}{pestilence}      {\def\allianceoptions@pestilence{#1}}
\define@key{allianceoptions}{wrath}         {\def\allianceoptions@wrath{#1}}
\define@key{allianceoptions}{introsentence}         {\def\allianceoptions@introsentence{#1}}
\newcommand{\defallianceoptions}{%
	\setkeys{allianceoptions}{change=, lust=, pestilence=, wrath=, introsentence=,}%
	\setkeys{allianceoptions}%
}
...
\define@key{commandgroup}{chosenofchangeopt}               {\def\commandgroup@chosenofchangeopt{#1}}
...
\define@key{commandgroup}{secondchampionoption}         {\def\commandgroup@secondchampionoption{#1}}
...
\newcommand{\defcommandgroup}{%
	\setkeys{commandgroup}{restriction=,
	                       champion=, chosenofchangeopt=, championallowance=, championoption=, secondchampionoption=, championprerestriction=, 
	...
	\ifstrempty{#1}{}{\commandgroupframestart\vspace*{-0.2cm}%
		\begin{description}[leftmargin=0.3cm, labelindent=0cm, labelsep=0cm, itemsep=0cm, parsep=0cm]%
			...
			\ifdefempty{\commandgroup@championprerestriction}{% There is no prerestriction to have a champion
				\item \hspace*{-0.04cm}\option{\labels@champion\ifdefempty{\commandgroup@chosenofchangeopt}{}{ \commandgroup@chosenofchangeopt}%
					...
					% Any second option available to the champion, in the form option:cost
					\ifdefempty{\commandgroup@secondchampionoption}{}{%
						\splitatinf{\commandgroup@secondchampionoption}\local@option\local@cost%
						\par\option{\hspace*{0.3cm}\local@option}{\local@cost}}%
			}{% There is a pre-restriction to have a champion
				\item \hspace*{-0.04cm}\commandgroup@championprerestriction	\newline%
				\option{\labels@champion\ifdefempty{\commandgroup@chosenofchangeopt}{}{ \commandgroup@chosenofchangeopt}}{\commandgroup@champion}%
				% Magical allowance of the champion. Should probably not be used, champion option can do it as well and is more flexible.
				\ifdefempty{\commandgroup@championallowance}{}{\par\option[\upto]{\hspace*{0.3cm}- \labels@championallowance}{\commandgroup@championallowance}}%
				% Any option available to the champion, in the form option:cost
				\ifdefempty{\commandgroup@championoption}{}{%
...
\define@key{unit}{alliance}{\def\unit@alliance{#1}}
\define@key{unit}{alliancepic}{\def\unit@alliancepic{#1}}
\define@key{unit}{allianceoptions}{\def\unit@allianceoptions{#1}}
		...
		singleextra={
			\expandafter\ifblank\expandafter{\unit@cost}{}{%
				...
				\node[unittitle,xshift=0.5cm] at (P-|O)%
					{\hypertarget{\unithypertag}{\Largefontsize\antiquefont\uppercase\expandafter\expandafter\expandafter{\unit@name}}};
...
\newcommand{\showunit}[1]{
	\defunit{#1}
	\def\unithypertag{\expandafter\macroname\expandafter{\unit@name}}
	...
	\begin{multicols}{2}
		...
		\expandafter\ifblank\expandafter{\unit@alliancepic}{
		\alignment{\unit@alignment}
		}{
		\begin{minipage}[c][][b]{0.045\textwidth}%
			\includegraphics[width=\textwidth]{pics/\unit@alliancepic.png}%
		\end{minipage}%
		...
		\expandafter\ifblank\expandafter{\unit@alliance}{}{\noindent\parbox{\columnwidth}{%
		\expandafter\ifblank\expandafter{\unit@alliancepic}{
		...
		\expandafter\ifblank\expandafter{\unit@allianceoptions}{}{\noindent\parbox{\columnwidth}{\expandafter\allianceoptions\expandafter{\unit@allianceoptions}}}

		\expandafter\ifblank\expandafter{\unit@greenhiderace}{}{\noindent\parbox{\columnwidth}{%
		\expandafter\ifblank\expandafter{\unit@alliancepic}{
		\greenhideraceentry{\unit@greenhiderace}
		}{
		\begin{minipage}[c][][b]{0.045\textwidth}%
			\includegraphics[width=\textwidth]{pics/\unit@alliancepic.png}%
		\end{minipage}%
	...
	\edef\temphypertag{\unithypertag}
	\expandafter\profiledtbfillhypertag\expandafter{\temphypertag}%
	...
	\expandafter\ifblank\expandafter{\unit@alliancepic}{}{\expandafter\profiledtbfillalliancepic\expandafter{\unit@alliancepic}}%
