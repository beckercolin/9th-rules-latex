...
\newcommand{\bigtitle}[1]{\section*{}\noindent\begin{center}\fontsize{25}{30}\selectfont\textbf{\antiquefont\expandafter\uppercase\expandafter{#1}}\end{center}}

\newcommand{\subtitle}[1]{\subsection*{}\noindent{\fontsize{18}{21.6}\selectfont\antiquefont #1}}

\newcommand{\subsubtitle}[1]{\subsubsection*{}\noindent{\fontsize{15}{18}\selectfont\antiquefont #1}}

\newcommand{\normalfontsize}{\fontsize{8}{9.6}\selectfont}
\newcommand{\largerfontsize}{\fontsize{10}{12}\selectfont}
...
\clearpage\bigtitle{\labels@mounts}\subtitle{}%
\renewcommand{\profilecategory}{\labels@mounts}%
}

\newcommand{\startarmyspecialrules}{\newpage\bigtitle{\labels@armyspecialrules}\largerfontsize}
\newcommand{\closearmyspecialrules}{\normalfontsize}
\newcommand{\armyspecialruleentry}[1]{\subtitle{#1}\vspace{5pt}}

\newcommand{\startarmyarmoury}{\bigtitle{\labels@armoury}\largerfontsize\subtitle{}}
\newcommand{\closearmyarmoury}{\normalfontsize}

\newcommand{\startarmymagicalitems}{\newpage\largerfontsize\bigtitle{\labels@magicalitems}\begin{multicols}{2}\raggedcolumns}
...
\newcommand{\startarmynewsection}[1]{\newpage\bigtitle{#1}\largerfontsize}
\newcommand{\closearmynewsection}{\normalfontsize}

\newcommand{\armynewsubsection}[1]{\subtitle{#1}}
\newcommand{\armynewsubsubsection}[1]{\subsubtitle{#1}}

\newcommand{\armylist}{\clearpage}

\newcommand{\quickrefsheettitle}{\clearpage\newgeometry{top=1.6cm, bottom=2cm, left=1cm, right=1cm}\bigtitle{\labels@quickrefsheet}\subtitle{}}
\newcommand{\changelogtitle}{\clearpage\bigtitle{\labels@changelog}\subtitle{}}
...
% Equipment entry.
\newcommand{\weapons}[1]{\unitentry{#1}{\textit{\labels@weapons\spacebeforecolon{}:}\newline\hspace*{-\fontdimen2\font}\expandafter\equipmentlist\expandafter{#1}.}}

\newcommand{\armour}[1]{\unitentry{#1}{\textit{\labels@armour\spacebeforecolon{}:}\newline\hspace*{-\fontdimen2\font}\expandafter\equipmentlist\expandafter{#1}.}}
		...
		singleextra={
			\expandafter\ifblank\expandafter{\unit@cost}{}{%
				...
				\node[unittitle,xshift=0.5cm] at (P-|O)%
					{\fontsize{14}{16.8}\selectfont\antiquefont\uppercase\expandafter\expandafter\expandafter{\unit@name}};
...
\newcommand{\defunit}{
	\setkeys{unit}{%
		name=, profile=, cost=, invocation=, costpermodel=, maxmodels=, type=, unitsize=, basesize=, commonspecialrules=, commontype=, specialrules=, magiclevel=, magicpaths=, equipment=, weapons=, armour=, wizardconclave=, unitequipment=, options=, mounts=, commandgroup=, unitrules=, additional=%
	}%
	\setkeys{unit}%
}
...
\newcommand{\showunit}[1]{
	...
	\expandafter\ifstrequal\expandafter{\unit@unitsize}{1}{% single model
		...
		\expandafter\ifblank\expandafter{\unit@maxmodels}{% no		
			...
			{\hspace*{0.25cm}\large \From{} \textbf{1} \wordto{} \expandafter\ifblank\expandafter{\unit@maxmodels}{}{\textbf{\unit@maxmodels{}}} \labels@models \hfill\pts{\textbf{\unit@costpermodel{}}}\permodel\hspace*{0.1cm}}%
		}%
	}{% not single model					
