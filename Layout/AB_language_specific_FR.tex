...
\newcommand{\labels@rulechanges}{%
	Les changements de règles entre versions sont colorés comme ce paragraphe. Une liste des changements est ajoutée à la fin de cet ouvrage, en anglais, classés par version.
}
