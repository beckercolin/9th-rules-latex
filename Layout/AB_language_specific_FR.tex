...
\newcommand{\translationteam}{\item \og AEnoriel \fg \item \og Anglachel \fg \item \og Batcat \fg \item \og Bigfish \fg \item \og Eru \fg  \item \og Gandarin \fg \item \og Groumbahk \fg \item \og Iluvatar \fg \item \og Lamronchak \fg \item \og Mammstein \fg \item \og Shlagrabak \fg \item et beaucoup d'autres...}
...
Toutes les règles sont disponibles gratuitement sur le site suivant :\newline
\url{http://www.the-ninth-age.com/index.php?simple-page/}\newline
...
\newcommand{\hidden}{Caché} % deprecated
...
\newcommand{\inspiringpresence}{Présence Exaltante}
\newcommand{\largetarget}{\toweringpresence} % deprecated
...
\newcommand{\thunderouscharge}{Charge Tonnante}
...
\newcommand{\wizardconclave}[1]{Conclave de Magiciens\ifblank{#1}{}{ (#1)}}


%%% Magic %%%

\input{../Layout/Paths_language_specific_FR.tex}
...
\newcommand{\hardterrain}{Décor Lourd}
\newcommand{\softterrain}{Décor Léger}
\newcommand{\hardcover}{Couvert Lourd}
\newcommand{\softcover}{Couvert Léger}
\newcommand{\ordnance}{\clippedwings} % deprecated
...
\newcommand{\flamethrowers}{Lance-Flammes}
