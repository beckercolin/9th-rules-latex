...
\newcommand{\weapononechoice}{\optionschoice{Arme \onechoiceonly{} :}}
\newcommand{\weaponschoice}{\optionschoice{Armes :}}
\newcommand{\shootingweapononechoice}{\optionschoice{Arme de Tir \onechoiceonly{} :}}
\newcommand{\combatweapononechoice}{\optionschoice{Arme de Corps à Corps \onechoiceonly{} :}}
\newcommand{\combatweapononechoiceTWOCOL}{\optionschoiceTWOCOL{Arme de Corps à Corps \onechoiceonly{} :}}
\newcommand{\armouronechoice}{\optionschoice{Armure \onechoiceonly{} :}}
\newcommand{\magiclevelchoice}{\optionschoice{Peut devenir au choix :}}
\newcommand{\bsboption}{Peut devenir \bsb{}}
\newcommand{\mayupgradeto}{Peut être amélioré en}
\newcommand{\mustbecomeoneofthefollowing}{\optionschoice{Doit devenir au choix :}}
\newcommand{\mustbecomeoneofthefollowingNOC}{Doit devenir au choix :}
\newcommand{\maybecomeoneofthefollowing}{\optionschoice{Peut devenir au choix :}}
\newcommand{\maytakeoneofthefollowing}{\optionschoice{Peut prendre au choix :}}
...
\newcommand{\maytakeuptotwoofthefollowing}{\optionschoice{Peut prendre jusqu'à deux choix :}}
\newcommand{\maytakeuptotwoofthefollowingTWOCOL}{\optionschoiceTWOCOL{Peut prendre jusqu'à deux choix :}}
\newcommand{\maygain}{Peut gagner la règle}
\newcommand{\maytake}{Peut prendre}
\newcommand{\maytakewardsave}[1]{Peut prendre une \wardsave{#1}}
...
\newcommand{\maytakeplatearmour}{Peut prendre une Armure de Plates}
...
\newcommand{\maytakealance}{Peut prendre une Lance de Cavalerie}
\newcommand{\maytakepw}{Peut prendre une Paire d'Armes}
\newcommand{\maytakeapistol}{Peut prendre un Pistolet}
\newcommand{\maytakeabraceofpistols}{Peut prendre une Paire de Pistolets}
\newcommand{\maytakethrowingweapons}{Peut prendre des Armes de Jet}
\newcommand{\maytakeashortbow}{Peut prendre un Arc Court}
\newcommand{\maytakeabow}{Peut prendre un Arc}
\newcommand{\maytakealongbow}{Peut prendre un Arc Long}
\newcommand{\maytakeacrossbow}{Peut prendre une Arbalète}
\newcommand{\maytakeahandgun}{Peut prendre une Arquebuse}
...
\newcommand{\maytakeonechoiceonlyTWOCOL}{\optionschoiceTWOCOL{\maytake{} \onechoiceonly{}\spacebeforecolon{}:}}
