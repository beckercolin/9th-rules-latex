...
Les changements récents sont décris en anglais sur le Change Log à la page : \newline\url{http://www.the-ninth-age.com/pdf/archive/}
}
...
Les changements de règles entre versions sont colorés comme ce paragraphe.
}
