...
\newcommand{\ironorc}{Orque en Fer}
\newcommand{\ironorcs}{Orques en Fer}
...
\newcommand{\axeoftheaporcalypse}{Hache de l’Aporcalypse}
\newcommand{\mazaszappinbow}{Arc Zap de Maza}
\newcommand{\backstabbingdirk}{Poignard Sournois}

\newcommand{\crownofthecavernking}{Couronne du Roi des Cavernes}
\newcommand{\platesoftuktek}{Plaques de Tuktek}

\newcommand{\panofprotectionpinchin}{Chapardeur de Défense}

\newcommand{\luckyboarsleg}{Sabot Porte-Bonheur}
\newcommand{\waaarghpaint}{Peintures Waaargh !}

\newcommand{\mikinokstotem}{Totem de Mikinok}
\newcommand{\ironhideicon}{Icône de Peau de Fer}
...
\newcommand{\pursuitmode}{Appuie sur le Champignon}
\newcommand{\smellslikegreenspirit}{Dès que le Vert Soufflera}
...
\newcommand{\goblinking}{Monarque Gobelin}
...
\newcommand{\goblinchief}{Patron Gobelin}
...
\newcommand{\orceadbasher}{Brise-Crâne Orque}
\newcommand{\orceadbashers}{Brises-Crânes Orques}
...
\newcommand{\goblinraider}{Pillard Gobelin}
\newcommand{\orcboarrider}{Orque sur Sanglier}
\newcommand{\orcboarriders}{Orques sur Sanglier}

% Special

\newcommand{\mountedeadbasher}{Brise-Crâne sur Sanglier}
\newcommand{\mountedeadbashers}{Brises-Crânes sur Sanglier}
\newcommand{\orcboarchariot}{Char à Sangliers}
\newcommand{\goblinwolfchariot}{Char à Loups}
\newcommand{\gnasherdasher}{Bondisseur Gniark}
\newcommand{\gnasherdashers}{Bondisseurs Gniarks}
...
\newcommand{\gnasherwreckingteam}{Équipe de Démolition Gniark}
\newcommand{\gnasherwreckingteamQRS}{Équipe de Dém. Gniark} %Normal name too long for QRS
...
\newcommand{\wolf}{Loup}
\newcommand{\cavegnasher}{Gniark des Cavernes}
\newcommand{\cavegnashers}{Gniarks des Cavernes}
\newcommand{\scuttlerspider}{Araignée}
\newcommand{\huntsmenspider}{Araignée de Chasse}


% Profile names

\newcommand{\rider}{Cavalier}
\newcommand{\eadbasherrider}{Brise-Crâne}
...
\newcommand{\mayexchangeallequipmentforcrossbowandha}{Échanger tout l'équipement contre une \crossbow{} et une \ha{}}
\newcommand{\eadbashersmodelnumbers}{\mincostfor{} \textbf{10} \labels@models{}. \maxunitsize{}\spacebeforecolon{}: \textbf{40} \labels@models{}.\hfill \additionalfigscost{} {\largefontsize\textbf{9} pts\permodel}\hspace*{0.1cm}}
\newcommand{\shadygitlimitation}{Maximum 1 \shadygit{} par tranche de 10 \commongoblins{} dans l'unité. Jusqu'à 3 \shadygits{}.}
\renewcommand{\pershadygit}{/Vengeur}
\newcommand{\madgitlimitation}{Maximum 1 \madgit{} par tranche de 15 \cavegoblins{} dans l'unité. Jusqu'à 3 \madgits{}.}
...
\newcommand{\takenets}{\nets}
\newcommand{\nomorethantwentymodels}{(20 figurines max.)}
...
\newcommand{\spidermothershrineoption}{Si le Cavalier est un Sorcier, \spidermothershrine}
...
Sur 2+, l'unité gagne la règle \poisonedattacks{} jusqu'à la fin de la Manche de Corps à Corps.

Sur un résultat de \result{1}, déterminer aléatoirement une unité ennemie en contact socle à socle avec l'unité. Elle gagne la règle \poisonedattacks{} contre l'unité ayant la règle \motherskiss{} jusqu'à la fin de la Manche de Corps à Corps.
}
...
\vspace{5pt}Ils peuvent être relâchés de deux façons :
\begin{itemize}[label={-}]
...
\item Tous les \madgits{} doivent être relâchés si l'unité les cachant n'est ni en fuite ni engagée au Corps à Corps au début de la Phase de Tir du propriétaire et qu'elle est à \distance{8} ou moins d'une unité ennemie.
\end{itemize}
...
Les Touches d'Impact de la \scrapwagon{} bénéficient de la règle \armourpiercing{2}.
}

\newcommand{\pursuitmoderule}{%
Lancez un dé supplémentaire et ignorez le dé ayant donné le résultat le plus bas pour le \randommovement{} pendant la Phase de Mouvement.
}
...
Au lieu d'attaquer normalement au Corps à Corps, un Troll peut choisir de faire une unique Attaque Spéciale de Corps à Corps qui touche automatiquement avec Force 5 et la règle \armourpiercing{6}.
}
...
L'\gnasherwreckingteam{} gagne la règle \runningamok{} quand il touche une unité pour la première fois de la partie.
}
...
Si l'\greatgreenidol{} est engagée au Corps à Corps, toutes les unités alliées à moins de \distance{8} peuvent gagner la règle \devastatingcharge{} ou un bonus de +1 pour blesser. Chaque unité choisit quel bonus utiliser au début de chaque Round de Corps à Corps.
}
...
\vspace*{5pt}\frenzy{}, \unruly{}, \borntofight{}, \wardsave{6}
\end{center}
...
L'unité gagne les règles \randommovement{X} et \immunetopsychology{}, et ne peut pas être rejointe par des Personnages. Si elle obtient le même résultat sur tous les dés de son jet de \randommovement{}, elle subit 1D3 blessures sans sauvegarde d'aucune sorte, puis se déplace de la distance obtenue dans une direction aléatoire.
...
La figurine ignore l'écart d'\distance{1} avec les autres unités. Si elle touche une autre unité, amie ou ennemie, au lieu de charger, elle continue son mouvement dans la même direction jusqu'à respecter la règle des \distance{1} d'écart entre unités et avoir parcouru au moins sa distance de mouvement. Si cela devait l'amener au contact ou à moins d'\distance{1} d'une autre unité, elle continue à se déplacer dans la même direction jusqu'à se trouver à plus d'\distance{1} de toute autre unité et avoir parcouru au moins sa distance de mouvement. Si elle se retrouve alors à moins d'\distance{1} d'un Terrain Infranchissable ou en dehors du champ de bataille, retirez-la comme perte.
...
Toutes les touches sont infligées avec la Force non modifiée de la figurine avec la règle \armourpiercing{1}.
...
\pricelistitem{\axeoftheaporcalypse}{65/45}Type : \hw{}. Le porteur gagne +1D3 en Force et +1D3 Attaques. Ces bonus sont déterminés et prennent effet au palier d'Initiative auquel le porteur attaque avec cette arme.

\pricelistitem{\mazaszappinbow}{30} \goblin{} uniquement.

Type : Arc. \range{24}, Force 3, \lightningattacks{}, \multipleshots{3}. L'unité du porteur gagne la règle \quicktofire{}.

\pricelistitem{\backstabbingdirk}{15}Type : \hw{}. Les attaques portées avec cette arme ont la règle \armourpiercing{1}. Si le porteur attaque une unité ennemie de flanc ou de dos, ses attaques avec cette arme gagnent +2 en Force.
...
\pricelistitem{\panofprotectionpinchin}{15}\goblin{} uniquement.
...
\pricelistitem{\luckyboarsleg}{20}Figurine montée uniquement.
...
\pricelistitem{\waaarghpaint}{15}\feralorc{} uniquement.
...
\pricelistitem{\mikinokstotem}{40}Les autres Objets Magiques dans l'unité du porteur ainsi que dans les unités amies ou ennemies en contact avec l'unité du porteur n'ont plus d'effet et redeviennent des objets ordinaires. L'effet sur les Objets Magiques des autres unités dure tant que les unités restent en contact.

\pricelistitem{\ironhideicon}{25}L'unité du porteur gagne une \wardsave{5} contre les Attaques de Tir.
