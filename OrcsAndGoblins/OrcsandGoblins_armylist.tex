...
\showunit{
	...
	options={
		\magicalitemsallowance{}=\upto{}<100,
		\maygain{} \greentide{} \only{\general}=\free,
		\anyofthefollowing{
			\shield{}=5,
			\ha{}=8,
		},
	...
	additional={%
		\startraceforking{3}%
			...
			\def\tempoptions{%
				...
				\takeshadygits{}\dotfill{}=\pershadygit{}<10,
				\shadygitlimitation{}
			}%
			\vspace*{0.1cm}\options{\tempoptions}
...
\showunit{
	...
	additional={%
		\startraceforkingrider{2}%
			...
			\def\tempoptions{\maytakealance{}=\permodel{}<2,}%
			\vspace*{0.1cm}\options{\tempoptions}%
...
\showunit{
	...
	armour={\la{},\mountsprotection{6}},
	specialrules={\impacthits{voir \rowsofteeth},\immunetopsychology{},\fly{6},\skirmishers{},\oiitbites{},\rowsofteeth{}},
	unitrules={%
		\unitrule{\oiitbites}{\oiitbitesrule}
...
\showunit{
	...
	options={\maytakeanorcoverseer{}=10,},
	unitrules={%
...
\showunit{
	...
	basesize=50x100,
	unitsize=1,
	specialrules={\shambolic{3D6},\impacthits{2D6},\insignificant{},\unstable{},\pursuitmode{}},
	weapons={\throwingweapons},
	armour={\mountsprotection{6}},
...
\showunit{
	name={\skewerer{} \zerotothreechoice},
	QRSname={\skewerer{}},
	cost={45},
	profile={%
		\machine{}< - - - - 7 3 - - -,
...
\showunit{
	...
	specialrules={\immunetopsychology{},\crushattack{},\impacthits{1D3},\smashemflat{},\iconofthewaaargh{}, \magicalattacks{}},
