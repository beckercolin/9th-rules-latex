...
Quand une \gnasherherd{} est démoralisée au Corps à Corps, elle est immédiatement retirée du champ de bataille comme perte, et toutes les unités à moins de \distance{6} subissent une touche de Force 5 par tranches de 5 \gnashers{} qui restaient dans la \gnasherherd{}.
}
...
Au lieu d'attaquer normalement au Corps a Corps, un Troll peut choisir de faire une unique Attaque Spéciale de Corps à Corps qui touche automatiquement avec Force 5 et \armourpiercing{6}.
}
...
Si l'\greatgreenidol{} est engagé au Corps à Corps, toutes les unités amies à moins de \distance{8} gagnent la \devastatingcharge{}.
}
...
\noindent$^{4}$ Un \rider{} de moins en tant que monture.
}
