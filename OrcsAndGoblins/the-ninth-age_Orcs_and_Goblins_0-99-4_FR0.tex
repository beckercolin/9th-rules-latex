...
Les \gnashers{} peuvent faire les Attaques de Soutien à la place de leurs Cavaliers. \newrule{Les \gnashers{} infligent des touches d'impact lorsqu'ils chargent. Le nombre de touches d'impact dépend du nombre de \gnashers{} dans l'unité. S'il y a 5 \gnashers{} ou moins, l'unité inflige 1D3 touches d'impact et s'il y a plus de 5 \gnashers{}, elle inflige 2D3 touches d'impact. Ces touches ne peuvent être infligées qu'à une seule unité ennemie en contact.}
}
...
\listitemonecol{\powershroom} \newrule{Une seule utilisation. Avant de jeter les dés pour lancer un sort qui n'est pas un objet de sort, le porteur peut décider d'utiliser un \powershroom{}. Toute tentative de dissipation de ce sort voit sa valeur réduite de 1D3. Si un '1' naturel est obtenu, le Sorcier utilisant le \powershroom{} subit une touche ayant la règle Attaques Toxiques.}
...
\newlog{0.99.4}{%
Great green idol,
Maza’s Zappin Bow ­: Goblins only,
Orc Boar Chariot price,
Orc Big Shaman mount options prices,
Giant base price and upgrade price,
Greenhide Catapults ­ Overseer price,
Goblin Chief and Goblin King prices of short bows and Greentide,
Axe of the Aporcalypse price,
Orc Chief wyvern price and one of a kind,
Orc Warlord Wyvern prices,
Boar Riders lance price,
Mounted Eadbashers price,
Gnasher Wrecking Team price,
Scrap Wagon pursuit mode free,
Grotlings vanguard,
Waaargh! Paint price,
Pan of Protection Pinchin’ price,
Gnasher Herd price,
Trolls price,
Iron Orcs price,
Goblins options prices,
Mad Git price and unit size restriction,
Gnasher Dashers lower number of impact hits,
Power ‘Shrooms,
Feral orc ladz cost,
Mounted gargantua cost,
Skewerer : may have up to 3,
Shady gits : cost,
}
