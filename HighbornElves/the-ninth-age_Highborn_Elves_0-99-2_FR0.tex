...
\newcommand{\swordsworn}{Serment de l'Épée} %M% faudrait demander à la VO, ça pourrait être loyal à l'épée
...
\newcommand{\stormpennant}{Fanion de Tempête} %M% Tempête du Ponant n'allait pas.
...
\newcommand{\highbornlancers}{Lances de Haute Lignée} %M% Verifier avec VO d'Argent. Nobre Lance, Chevaliers Altiers, sang noble, etc
...
\newcommand{\seaguardreaper}{Faucheuse Garde-Mer} %M% Ref à Garde-mer à ajouter
...
Les figurines comptent toujours comme n'ayant pas bougé pour la règle \volleyfire{}.
}
