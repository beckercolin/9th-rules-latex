...
\showunit{
	...
	options={
		\maygain{} \devastatingcharge{}=\permodel{}<5,
	},
	commandgroup={champion=10, championallowance=25, musician=10, banner=10, bannerallowance=50}
}
...
\showunit{
	...
	additional={%
		\def\tempspecialrules{\multiplewounds{2}{\monstrouscavalry{}, \monstrousbeasts{}, \monsters{}, \riddenmonsters{}} \only{\crew{}}, \impacthits{+1}, \valiant{}}
...
\showunit{
	...
	options={
		\anyofthefollowing{
			...
			\devastatingcharge{} \wordand{} \thunderouscharge{}=25,
		},
	},
}
...
\showunit{
	...
	options={
		\ifmountedbyhighprinceupgradetoancientdragon{}=100,
	},
}
