...
\newcommand{\exchangeshieldandvanguardforaspenbow}{Remplacer le \shield{} et \vanguard{} par un \aspenbow{}}
...
\newcommand{\giantaspenbowrule}{%
 Arme de Tir. \range{48}, Force 6, \multiplewounds{1D3}, \armourpiercing{6}. Cette arme ignore tous les modificateurs pour toucher au tir. Compte comme une \hw{} avec -1 en Force au Corps à Corps.
}
...
Le \casketofphatep{} possède un \boundspell{4} : \sandsspellfour{} (Discipline \sands{}). Il ne peut l'utiliser que si il ne s'est pas déplacé durant ce Tour de Joueur.
}
...
Une unité qui subit au moins une perte suite à cette arme doit subir un test de Panique comme si elle avait subit au moins 25\% de pertes. Ce test est fait avec un malus de -1 en Commandement.
}
