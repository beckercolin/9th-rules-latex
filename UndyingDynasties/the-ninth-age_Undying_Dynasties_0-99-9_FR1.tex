...
\newcommand{\deathmaskofteput}{Masque de Mort de Temut}
...
\newcommand{\tombcataphract}{Cataphracte des Tombes}
\newcommand{\tombcataphracts}{Cataphractes des Tombes}
...
\begin{itemize}[label={-}]
\item \heavensspellone{} (\Pathof{} \heavens{}),
\item \heavensspellfour{} (\Pathof{} \heavens{}),
\item \sandsspellfive{} (\Pathof{} \sands{}).
\end{itemize}
...
Arme de Corps à Corps. Type : \hw{}. Le porteur a -1 Attaque au Corps à Corps. Le porteur gagne deux \boundspells{4} : \deathsignature{} (\Pathof{} \death{}) et \lightsignature{} (\Pathof{} \light{}).
}
...
Votre armée doit contenir au moins un Sorcier qui utilise la \Pathof{} \sands{} que vous désignez comme étant votre Hiérophante. Il doit être indiqué sur votre liste d'armée. Le Hiérophante et toutes les figurines de son unité gagnent la règle \regeneration{6}.
...
Toutes les unités alliées dans un rayon de \distance{6} d'au moins une figurine avec cette règle réduisent le nombre de blessures qu'elle subissent par les règles \dusttodust{} et \unstable{} de 1. Les figurines avec la règle \necromanticaura{} ne peuvent pas en bénéficier elles-mêmes.
...
\listitemonecol{\greataspenbow} Arme de Tir. \range{36}, Force 5, \volleyfire{}. Cette arme ignore tous les modificateurs pour toucher au tir. Compte comme une Arme spéciale de Corps à Corps avec -1 en Force au Corps à Corps.
...
Les \impacthits{} causées par le \chariot{} du porteur, ainsi que les Attaques de ses montures gagnent les règles \flamingattacks{} et \magicalattacks{} et sont résolues avec +1 en Force.
...
\pricelistitem{\bookofthedead}{50/35} La valeur de lancement des sorts de la \Pathof{} \sands{} est réduite de 1 pour le porteur. De plus, l'Attribut de la \Pathof{} \sands{} lancé par le porteur Ressuscite 1 PV supplémentaire sur la ou les unités ciblées qui ne sont ni des Personnages ni des Grandes Cibles.
...
\input{UndyingDynasties_armylist.tex}
