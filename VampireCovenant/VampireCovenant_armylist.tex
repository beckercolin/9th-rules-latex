...
\showunit{
	...
	additional={
		\def\tempspecialrules{\multiplewounds{2}{\infantry{}, \warbeast{}, \cavalry{}}, \lethalstrike{}, \notaleader{}, \magicalattacks{}}
...
\showunit{
	...
	additional={%
		...
		\columnbreak
		\begin{center}\largerfontsize\antiquefont\banshee{} (\pts{100})\end{center}
...
\showunit{
	...
	commontype=\undeadcommonrules{},
	commonspecialrules={\undead{}, \ashestoashes},
	specialrules={\magicalattacks{}, \multiplewounds{2}{\infantry{}, \warbeast, \cavalry{}}, \lethalstrike{}, \bodyguard{\general, \barrowking}},
	armour={\ha},
	options={
		\onechoiceonly{
			\shield{}=\permodel{}<1,
...
\showunit{
	...
	commandgroup={champion=10, musician=10, banner=10, bannerallowance=50},
	additional={%
		\def\tempspecialrules{\magicalattacks{}, \multiplewounds{2}{\infantry{}, \warbeast, \cavalry{}} \only{\rider}, \lethalstrike{} \only{\rider}, \ethereal{} \only{\steed}}
