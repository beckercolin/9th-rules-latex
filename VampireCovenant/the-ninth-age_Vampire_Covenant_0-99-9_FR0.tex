...
\newcommand{\ashestoashes}{Poussière Tu Redeviendras Poussière}
...
\newcommand{\discordantchorus}{Ch\oe{}ur Dissonant}
...
\newcommand{\necromancyspellfour}{Conscription Profanatoire}

\newcommand{\deathsignaturespell}{Le Baiser de la Faucheuse}
\newcommand{\shadowssignaturespell}{Miasmes Obscurs}
...
\newcommand{\vampirehero}{Baron Vampire}
\newcommand{\vampireheroes}{Barons Vampires}
\newcommand{\barrowking}{Roi des Tertres}
\newcommand{\barrowkings}{Rois des Tertres}
\newcommand{\necromancer}{Nécromant}
\newcommand{\fellwraith}{Apparition Lugubre}
\newcommand{\banshee}{Âme en Peine}
...
\newcommand{\greatbats}{Grandes Chauves-Sou\-ris}
\newcommand{\ghast}{Atrocité}
\newcommand{\ghasts}{Atrocités}
\newcommand{\cadaverwagon}{Charrette à Cadavres}
\newcommand{\cadaverwagons}{Charrettes à Cadavres}
\newcommand{\varkolak}{Varkolak}
\newcommand{\phantomhost}{Horde de Spectres}
\newcommand{\vampirespawn}{Progéniture Vampi\-ri\-que}
...
\newcommand{\wraith}{Apparition Vaga\-bon\-de}
\newcommand{\wraiths}{Apparitions Vaga\-bon\-des}
...
\newcommand{\awakenedvampire}{Vampire Réveillé}
...
Si au moins la moitié des figurines d'une unité possèdent cett règle, elle subit une blessure de moins lors de l'application des règles \unstable{} et \ashestoashes{}.
}
...
Au début de chaque Tour de Joueur allié et avant la bataille, juste avant de déplacer les unités avec \vanguard{}, choisissez l'un des effets suivants. Dans les deux cas, X est la valeur du Tour de Jeu actuel, et vaut 0 avant la bataille.
	\begin{itemize}[label={-}]
		\item Toutes les unités amies à moins de \distance{6+X} gagnent la \regeneration{6} jusqu'à la fin du tour de joueur suivant. Placez un marqueur à côté des unités affectées par la \regeneration{} après avoir déterminé l'aire d'effet. Une unité ayant déjà la \regeneration{} améliore sa sauvegarde de \regeneration{} d'un point pour obtenir 4+ au mieux. Seule cet effet peut être choisi avant la bataille.
...
Une unité composée uniquement de figurines avec cette règle peut effectuer des Marches Forcées même lorsqu'elle se trouve hors de portée de la \inspiringpresence{} du Général. Elle doit toujours effectuer un test de Commandement si elle se trouve dans un rayon de \distance{8} d'une unité ennemie.
...
\end{wrapfigure}
Le Vampire perd une Attaque, subit un malus de -2 en Capacité de Combat et ne peut porter aucune Armure, à l'exception de la \mountsprotection{} et de la \innatedefence{}. Il ne peut pas porter d'Arme standard. Il devient un \magiclevel{2} si c'est un Héros ou un \magiclevel{4} si c'est un Seigneur. Il gagne \awaken{\skeletons{}, \zombies{}} et génère un sort supplémentaire, mais doit échanger un de ses sorts pour l'\necromancysignaturespell{} (Discipline \necromancy{}).
...
\pricelistitem{Combattant Ultime}{35} Le Vampire gagne les règles \weaponmaster{} et \lethalstrike{}. Il est équipé d'une \pw{}, d'une \halberd{}, d'une \gw{}, d'une \lance{} et d'un \shield{}.
...
\pricelistitem{Goût Raffiné}{25} Le Vampire gagne la règle \vampiric{2}.

\pricelistitem{L'Heure du Loup}{20} Le Vampire gagne la règle \awaken{\zombies{}, \direwolves{}, \batswarms{}, \greatbats{}}. Le Vampire ainsi que les figurines de l'unité qu'il rejoint gagnent la règle \swiftstride{}, à l'exception des autres Personnages ayant la règle \vampiric{}.
...
\pricelistitem{Regard Hypnotique}{35} Le Vampire possède un \boundspell{4} : \lustspellfour{} (Discipline \lust{}).
...
\vspace*{-1.45cm} % Manual adjustment, change it for your own translation
\armynewsubsection{\begin{center}Indépendant ou \strigoi{}\end{center}}
\vspace*{-0.2cm} % Manual adjustment, change it for your own translation
\startpricelist
...
\pricelistitem{Roi des Goules}{55} Le Vampire et sa monture gagnent les règles \poisonedattacks{} et \armourpiercing{1}. Les \ghouls{} de l'unité qu'il rejoint gagnent la \hatred{}.
...
\pricelistitem{Connaissance des Arcanes}{30} Les sorts lancés par le Vampire ont une Portée augmentée de \distance{6}. Cet effet est réduit à \distance{3} pour les sorts de type Aura. Les sorts de Vortex, les Objets de Sort et les sorts sans Portée ne sont pas affectés.

\pricelistitem{Discipline Interdite}{20} Le Vampire peut générer ses sorts dans la Discipline \necromancy{} ou dans n'importe laquelle des Disciplines Communes, à l'exception \nature{}.
...
Type: \hw{}. Le Vampire maniant cette lame gagne \vampiric{3}. L'élément de figurine lance 1D6 pour chaque blessure qu'il inflige dans le cadre de sa règle \vampiric{}, au lieu d'un seul dé. Chaque jet \vampiric{} réussi lui rend un PV, puis tout excès de PV ainsi Ressuscité peut être utilisé pour \raisewounds{} dans l'unité que le personnage a rejointe.
...
Le porteur possède une \wardsave{2} contre la première blessure subie de la partie, après les Sauvegardes d'Armure. Il est immunisé aux effets du \lethalstrike{} et des \multiplewounds{}{}.

\pricelistitem{Linceul de Nuit}{40} Infanterie ou Cavalerie uniquement.
...
\pricelistitem{Dents de Tullius}{50} Le porteur gagne la règle \distracting{}. Toutes les figurines ordinaires d'\infantry{} et de \cavalry{} de son unité gagnent la \parry{}.
...
\pricelistitem{Baguette de Gerhard Langue Noire}{45} Une armée possédant cet objet peut relancer ses jets de Canalisation ratés. De plus, quand le porteur lance le sort \necromancysignaturespell{} (Discipline \necromancy{}), un dé pour déterminer le nombre de Points de Vie Ressuscités peut être relancé pour chaque unité ciblée.

\pricelistitem{Tome Impie}{35} \boundspell{4} : \necromancyspelltwo{} (Discipline \necromancy{}).

\pricelistitem{Œil de Setesh}{15} Une seule utilisation. À la fin d'une Phase de Magie adverse, vous pouvez mettre un Dé de Dissipation inutilisé de côté. Ce dé pourra être ajouté à votre réserve comme Dé de Pouvoir, juste après avoir déterminé les Flux de Magie.
...
\pricelistitem{Étendard Noir de Zagvozd}{40} Toutes les figurines de l'unité obtiennent une \wardsave{4} contre les Attaques de Tir. 
