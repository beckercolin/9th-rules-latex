...
Les Vampires \strigois{} dans la même unité peuvent faire le mouvement d'\vanguard{} avec elle.
}
...
Les figurines ennemies qui pourraient allouer des attaques de Corps à Corps à une figurine avec cette règle spéciale ne peuvent pas choisir de cibler plutôt un \necromancer{} ou un \necromancerlord{}. Cette règle ne peut pas être utilisée s'il y a des figurines avec la règle \vampiric{} dans la même unité.
}}
...
Peut gagner une \platearmour{} et \devastatingcharge{} \newrule{(\rider{} seulement)}%
}
...
Les \wizards{} amis à moins de \distance{12} d'au moins un \altarofundeath{} équipé d'un \darktome{} ajoutent +2 à leurs tentatives de lancement de Sorts de la Discipline \necromancy{} \removedrule{(jusqu'à un maximum de +3)}. Tout \wizard{} subissant un Fiasco à moins de \distance{12} d'un \altarofundeath{} équipé d'un \darktome{} compte comme ayant utilisé deux Dés de Pouvoir supplémentaires pour lancer le sort (maximum 5).
}
...
\vspace{0.5cm}
\ancientbloodpower{} : \textbf{\newrule{Occultisme du Sang}}\dotfill\pts{\newrule{75}}\newline%
