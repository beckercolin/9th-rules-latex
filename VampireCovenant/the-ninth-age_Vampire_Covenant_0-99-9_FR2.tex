...
\newcommand{\wraith}{Spectre} %L% il y avait en plus vagabonds, vous voulez laisser ?
...
\vspace{0.5cm}
\ancientbloodpower{} : \textbf{Autorité}\dotfill\pts{50}\newline%
...
\pricelistitem{Baguette de Gerhard le Noir}{45} Une armée possédant cet objet peut relancer ses jets de Canalisation ratés. De plus, quand le porteur lance le sort \necromancysignaturespell{} (Discipline \necromancy{}), un dé pour déterminer le nombre de Points de Vie Ressuscités peut être relancé pour chaque unité ciblée.
