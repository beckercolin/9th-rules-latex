...
\newcommand{\balefuldarkcoachrule}{\newrule{%
...
\armynewsubsection{\bloodline{} \vonkarnstein{}\dotfill\pts{\newrule{25}/\newrule{10}}}
...
Toute les figurines ordinaires de l'unité rejointe par la Vampire obtiennent une Capacité de Combat de 5. Si la Vampire n'est pas engagée au corps à corps, elle peut à la place, \newrule{au début d'une Phase de Corps à Corps et pour la durée de cette phase}, donner ce bonus à une unique unité amie située dans un rayon de \distance{6}.

\armynewsubsection{\bloodline{} des \strigois{}\dotfill\pts{50/\newrule{30}}}

\begin{wrapfigure}[5]{R}{0cm}
\centering
\includegraphics[width=\logosize]{logos/logo_strigoi.png}
\end{wrapfigure}
La figurine du Vampire gagne +1 Point de Vie, obtient une \regeneration{5} et est sujet à la \hatred{}. Le Vampire ne peut pas prendre de monture à l'exception d'une \shriekinghorror{}, ne peut porter aucune Armure\newrule{, sans compter la \mountsprotection{}}, et ne peut acheter qu'un seul Niveau de Magie supplémentaire. Il doit utiliser la Discipline \wilderness{} ou \necromancy{}.
...
Le Vampire fait des \poisonedattacks{} et a \armourpiercing{1}. Les \ghouls{} de l'unité qu'il rejoint gagnent la \hatred{} et \armourpiercing{1}.
...
\end{wrapfigure}
Le Vampire perd une Attaque, subit un malus de -2 en Capacité de Combat et ne peut porter aucune Armure\newrule{, à l'exception de la \mountsprotection{} et de la \innatedefence{}}. \newrule{Il ne peut pas porter d'Arme standard.} Il devient un \magiclevel{2} si c'est un Héros et un \magiclevel{4} si c'est un Seigneur. Il génère un sort supplémentaire et gagne \awaken{\skeletons{}, \zombies{}}. Un Vampire \nosferatu{} peut choisir ses sorts dans toutes les Disciplines \newrule{qui lui sont ouvertes} au lieu d'une seule. Les informations sur les Disciplines choisies et combien de sorts sont générés dans chaque Discipline doivent figurer dans la Liste d'Armée. \newrule{Si cette capacité est combinée avec la règle \pathmaster{}, le nombre de sorts choisi dans chaque Discipline doit être inscrit sur la Liste d'Armée, et le Vampire peut ensuite sélectionner ses sorts au bon vouloir du joueur en suivant cette contrainte.}

\vspace{0.5cm}
\bloodties{} : \textbf{\wraiths{}}.

\vspace{0.5cm}
\ancientbloodpower{} : \textbf{\newrule{Pouvoir de l'Esprit}}\dotfill\pts{\newrule{75}}\newline%
\newrule{Le Vampire compte toujours comme ayant utilisé un Dé de Pouvoir de moins en cas de Fiasco. Immédiatement après avoir lancé les dés pour déterminer la force des Flux Magiques pendant votre tour, vous pouvez choisir de relancer un des dés. Dans ce cas, le Vampire subit une blessure sans aucune sauvegarde possible à la fin de la Phase de Magie.}
...
\pricelistitem{Goût Raffiné}{25} Le Vampire obtient \vampiric{2}\removedrule{, ou \vampiric{4} s'il est monté sur une \largetarget{}}.

\pricelistitem{L'Heure du Loup}{20} Le Vampire gagne \awaken{\zombies, \direwolves, \batswarms, \greatbats}, et le Vampire ainsi que l'unité qu'il rejoint gagnent la règle \swiftstride{}\newrule{, à l'exception des autres Personnages ayant la règle \vampiric{}}.
...
\pricelistitem{Regard Hypnotique}{\newrule{35}} \newrule{Le Vampire possède le sort \lustspellfour{} (Discipline \lust{}) comme \boundspell{4}.}
...
\pricelistitem{Malédiction du Sang}{70} Le Vampire gagne \regeneration{5}. \newrule{S'il possédait déjà une \regeneration{}, il gagne \regeneration{4}}. Toutes les \ghouls{} dans la même unité que le Vampire et son éventuelle monture gagnent \regeneration{6}. Si une figurine affectée par cette capacité possède déjà la \regeneration{}, sa sauvegarde de \regeneration{} est améliorée d'un point, pour obtenir 4+ au mieux.

\pricelistitem{\newrule{Forme Bestiale}}{\newrule{55}} \newrule{Figurines à pied uniquement. Le type de troupe du Vampire devient \monstrousinfantry{} et la taille de son socle passe à \unit{40x40}{\milli\meter}. Il gagne +1 PV, +1 en Force, \regeneration{5} et son Endurance passe à 5. Il est équipé d'une \pw{} et ne peut manier aucune autre Arme, standard ou magique. Il n'a accès à aucune monture et ne peut porter aucune sorte d'Armure.}
...
\pricelistitem{Connaissance des Arcanes}{25} \newrule{Les sorts lancés par le Vampire ont une Portée augmentée de \distance{6}. Cet effet est réduit à \distance{3} pour les sorts de type Aura. Les sorts de Vortex, les Objets de Sort et les sorts sans Portée ne sont pas affectés}.
...
\pricelistitem{\removedrule{Arc de Nepharet}}{\removedrule{45}}

\pricelistitem{Lame de la Soif Rouge}{40} Vampires uniquement.\newline Type: \hw{}. Le Vampire maniant cette lame \newrule{gagne \vampiric{3}}. L'élément de figurine lance 1D6 pour chaque blessure qu'il inflige dans le cadre de sa règle \vampiric{}. Tout excès de PV ainsi Ressuscité peut être utilisé pour \raisewounds{} dans l'unité que le personnage a rejointe.
...
\pricelistitem{\newrule{Anneau d'Éternité}}{\newrule{60/50}} \newrule{Vampires uniquement.\newline Le porteur possède une \wardsave{2} contre la première blessure subie (après les Sauvegardes d'Armure) de la partie, et est immunisé aux effets du \lethalstrike{} et des \multiplewounds{}{}.}
...
\pricelistitem{Étendard Noir de Zagvozd}{\newrule{40}} \newrule{Toutes les figurines de l'unité obtiennent une \wardsave{4} contre les Attaques de Tir}. 

\pricelistitem{Bannière des Rois des Tertres}{\newrule{25}} Les figurines de \barrowknights{} et de \barrowguards{} \removedrule{et de \barrowkings{}} de l'unité obtiennent +1 pour toucher au Corps à Corps.
