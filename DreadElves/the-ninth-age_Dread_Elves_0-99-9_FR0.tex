...
\newcommand{\maytakearepeaterhandbow}{Peut prendre une \repeaterhandbow}
...
\newcommand{\nightshaderule}{%
Les attaques faites avec ce \poison{} sont résolues avec une Force égale à l'Endurance de la cible +1, jusqu'à une Force de 6 maximum. Ignorez cette règle si la Force des attaques était déjà supérieure.
}
...
Au début de chaque Tour de Jeu allié et avant le début de la partie, juste après avoir déplacé les unités avec \vanguard{}, choisissez l'une des faveurs ci-dessous. Elle s'applique jusqu'au début du prochain Tour de Jeu allié.
...
Désignez une Attaque de Corps à Corps normale d'un élément de figurine avec cette règle spéciale avant d'effectuer les jets pour toucher. Cette attaque a Force 4 et \armourpiercing{6}. Le jet pour blesser est effectué contre l'Initiative de la cible au lieu de son Endurance. Ne peut pas être utilisé en tant qu'attaque de support.
...
Les unités alliées constituées uniquement de figurines montées ou de \monsters{} à moins de \distance{12} de cette figurine lancent un dé supplémentaire pour leurs tests de \frenzy{} et de \stupidity{} et ignorent le dé avec le résultat le plus grand.

Au début de chaque Phase de Corps à Corps, une unité alliée de \cavalry{}, \chariot{}, \monstrouscavalry{} ou un \monster{} à moins de \distance{6} de cette figurine peut gagner la \hatred{} pour le reste de la manche. Seules les montures sont affectées. Remarquez que la \hatred{} n'a d'effet que lors de la première manche de Corps à Corps et qu'il n'est pas possible de cibler un \riddenmonster{}.
...
\pricelistitem{Amulette Malveillante}{35}Si un Sorcier ennemi à moins de \distance{12} tente de lancer un sort, et qu'au moins deux des Dés de Pouvoirs utilisés ont eu pour résultat un double, le lanceur subit un Fiasco. Un unique lancer de sort ne peut pas générer plus d'un Fiasco.
...
\pricelistitem{Étendard de Gar Daecos}{60}\fleetcommander{} uniquement.\newline Toutes les unités de \corsairs{} et de \dreadlegionnaires{} à moins de \distance{6} du porteur reçoivent un bonus de +1 pour blesser au Corps à Corps.

\pricelistitem{Bannière Ensanglantée}{35}Les éléments de figurine dotés de la règle \killerinstinct{} de l'unité du porteur peuvent relancer les résultats de \result{1} ou \result{2} de leurs jets pour blesser ratés au Corps à Corps.
