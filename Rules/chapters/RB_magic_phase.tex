...
\begin{itemize}[label={-}]
\item \textbf{1 à 5} : \newfromWHB{Multipliez le résultat du dé par la valeur X de la Portée du \vortex{}.} Le résultat est la distance que le Gabarit parcourt dans la direction partant de sa position initiale vers la cible\newfromWHB{, qui est toujours un point sur le champ de bataille, puisque tous les sorts de \vortex{} sont aussi de type \ground{}}.
