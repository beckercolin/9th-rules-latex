...
Quand le combat se termine, calculez le Résultat de Combat comme d'habitude, \newfromWHB{sauf que l'unité en Garnison compte comme n'ayant aucun rang, pour le Résultat de Combat et pour être Indomptable, et les Étendards (communs ou Grande Bannière) ne comptent que si les figurines les portant participent au combat.} Une fois le combat résolu, trois cas sont possibles :
...
\item \newfromWHB{Si les Assiégeants l'emporte et que toutes les unités ennemies ont raté leur test de Moral et fuit ou ont été annihilées, ils peuvent soit choisir de rentrer dans le Bâtiment (s'ils le peuvent), soit effectuer un Pivot Post-Combat, en ignorant le Bâtiment, puis être poussés à \distance{1} du Bâtiment. Dans le cas d'un Combat Multiple, ils peuvent aussi choisir de poursuivre une unité ennemie en fuite \textbf{si ce n'était pas} l'unité en Garnison.}
