...
\newrule{On parle de Gabarit linéaire lorsqu'on trace une ligne droite entre deux points. Toutes les figurines en dessous de cette ligne sont considérées comme étant sous le gabarit. Une méthode simple et conviviale pour déterminer le nombre de touches d'un Gabarit linéaire consiste à multiplier le nombre de rangs traversés par 2, puis soustraire 1 au résultat. Dans l'exemple ci-dessous, 4 rangs sont traversés par la ligne droite. 4 x 2 - 1 = 7, donc 7 figurines sont touchées.}
