...
Les unités doivent toujours laisser un espace d'au moins 1{\pouce} entre elles, et avec les Terrains Infranchissables. Ceci s'applique aux unités alliées comme adverses. \nouveau{Pendant un déplacement, cette distance est réduite à 0,5{\pouce}, mais à la fin du déplacement, l'unité doit toujours respecter la \emph{Règle du Pouce d'Écart}. Si ce n'est pas le cas, revenez en arrière dans le mouvement jusqu'à ce que l'espace de 1{\pouce} soit respecté}.

Quelques déplacements spéciaux autorisent une entorse à la \emph{Règle du Pouce d'Écart}, comme les charges. \newrule{Si une unité est autorisée à se retrouver à moins de 1{\pouce} d'une autre unité ou d'un \emph{Terrain Infranchissable}, elle peut ignorer la \emph{Règle du Pouce d'Écart} par rapport à cette unité ou ce \emph{Terrain Infranchissable} aussi longtemps qu'elle reste à moins de 1{\pouce}. Elle ne peut cependant jamais entrer en contact socle à socle avec une unité ennemie qu'elle n'a pas chargée}.
