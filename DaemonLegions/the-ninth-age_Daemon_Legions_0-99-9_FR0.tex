...
\newcommand{\slaughterer}{Massacreurs}
...
\newcommand{\ifthegeneralbelongstothesamedarkgodmaytake}{\optionschoice{Si le Général est de même affiliation{,} peut prendre :}}
\newcommand{\mayreplacebloodswordwithhellbladeandinnatedefence}{Remplacer l'\bloodsword{} par la \hellblade{} et \innatedefence{5}}
\newcommand{\inamonotheistarmymaytake}{\optionschoice{Si c'est une Armée Monothéiste il peut prendre :}}
\newcommand{\mayreplacebloodswordwithhellbladerideronlyandinnatedefence}{Remplacer l'\bloodsword{} par la \hellblade{} \only{\rider{}} et \innatedefence{5}}
\newcommand{\temptressmaytakealashoflust}{La \temptress{} peut prendre un \lashoflust{}}
...
Arme de tir : \range{18}, Force 4, \multipleshots{1D3}, \quicktofire{}.
}

\newcommand{\slashingrule}{%
\sweepingattack{}, l'unité ennemie subit 1D3 touche Force 3 par \skyserpent{} de l'unité.
}
...
\range{8}, Force 4, \flamingattacks{}. Ignorez le malus de -1 sur le tableau des incidents d'\artilleryweapon.
}
...
\begin{itemize}[label={-}]
	\item Comme une \textbf{\artilleryweapon} de type \textbf{\boltthrower} (\distance{2D6}).\newline
		\range{24}, Force 4+1D3*, \multiplewounds{1D3}{}, \armourpiercing{6}.
	\item Comme une \textbf{\artilleryweapon} de type \textbf{\volleygun}.\newline
		\range{12}, Force 2+1D3*, \multipleshots{6}.
\end{itemize}
* Lancez une fois par phase de tir (après que les jets pour toucher aient été lancés) et appliquez cette Force à toutes les touches faites par cette arme. 
}

\newcommand{\auraofecstasyrule}{%
Toutes les figurines \daemonoflust{} engagées dans le même combat qu'une figurine avec cette règle (y compris elle-même) gagnent \lightningreflexes{}.
}

\newcommand{\soulreaperrule}{%
Les \impacthits{} infligées par un \carnalchariot{} gagnent \armourpiercing{6}. De plus, l'\oracle{} gagne +1 Attaque pour chaque blessure non sauvegardée causée par les \ímpacthits{} du \chariot{}. Ces Attaques sont perdues à la fin de la manche de combat.
}
...
\alliancesidepic{logo_big_DL.png}
...
%{} & \cannon{} (\distance{1D6}) & \distance{48} & 10 & - & \ordnance{} & 2 \tabularnewline
%\end{tabular}
