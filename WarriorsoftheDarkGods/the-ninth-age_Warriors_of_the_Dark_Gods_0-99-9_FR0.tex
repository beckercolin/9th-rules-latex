...
\newcommand{\maytakeasinglegiftbarbarian}{Un seul Don des Dieux Sombres (si Général)}
...
\textbf{\dchange} & \boundspell{5}. \changespelltwo{} (\Pathof{} \change{}). \tabularnewline
...
\columnbreak
\pricelistitem{\wildlingblood}{40} Le porteur gagne la règle \inspiringpresence{}, qu'il soit le Général ou non. Cependant, seules les unités de type Bête de Guerre, Infanterie Monstrueuse, Bête Monstrueuse ou Monstre peuvent bénéficier de cette règle si le porteur n'est pas le Général.
...
\input{WarriorsoftheDarkGods_armylist.tex}
