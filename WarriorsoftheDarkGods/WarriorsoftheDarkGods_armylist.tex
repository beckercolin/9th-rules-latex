	...
	additional={%
		\def\tempmounts{
			\optionschoiceTWOCOL{}{
				...
				\columnbreak\discofchange{}=60,
				\crusher{}=40,
				\steedoflust{}=40,
				\pestilentpalanquin{}=15,
			},
		}
		\mounts{\tempmounts}
	},
...
\showunit{
	...
	additional={%
		\def\tempoptions{\mayexchangefastcavformountsprotection{}=10,}
...
\showunit{
	...
	additional={%
		\def\tempspecialrules{\poisonedattacks{} \only{\steed},\fastcavalry{},\lightningreflexes{} \only{\rider}}
...
\showunit{
	...
	alliance={\markofwrath},
	alliancepic={wrath},
	specialrules={\magicalattacks{} \only{\rider},\chosenofthegods{} \only{\rider},\fear},
